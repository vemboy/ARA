          ...
          <div className="metadata-row">
            ...
            <div>
              {sideARecord && sideARecord.names_side_a ? (
                <div dangerouslySetInnerHTML={{ __html: sideARecord.names_side_a }} />
              ) : (
            ...
            <div>
              {sideBRecord && sideBRecord.names_side_b ? (
                <div dangerouslySetInnerHTML={{ __html: sideBRecord.names_side_b }} />
              ) : (
          ...
          <div className="metadata-row">
            ...
            <div>
              {sideARecord && sideARecord.online_format_side_a ? (
                sideARecord.online_format_side_a
              ) : (
            ...
            <div>
              {sideBRecord && sideBRecord.online_format_side_b ? (
                sideBRecord.online_format_side_b
              ) : (
